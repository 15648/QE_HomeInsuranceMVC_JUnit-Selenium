...
public class BuyQuoteTest {
	...
	public static void setUp() {
		...
		WebElement proceedToBuy = driver.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td[2]/form/table/tbody/tr[10]/td/input"));
		proceedToBuy.click();
		
		//Buy Quote
		WebElement buyQuote = driver.findElement(By.xpath("/html/body/div[2]/form/button[1]"));
		buyQuote.click();
		
		//Buy Policy
		WebElement dateInput = driver.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td[2]/form/table/tbody/tr[1]/td[2]/input"));
		dateInput.sendKeys("02/14/2019");
		
		WebElement acknowledge = driver.findElement(By.xpath("//*[@id=\"read\"]"));
		acknowledge.click();
